...
import os
from custom_russian_transliteraion import custom_transliterate
...
def transliterate_file(input_path, output_path):
    ...
    transliterated_lines = [custom_transliterate(line) for line in lines]
...
# Apply to your Russian Wikipedia and bank review files
transliterate_file("data/ru/russian_cleared_wikipedia.txt", "data/ru/russian_cleared_wikipedia_translit2.txt")
transliterate_file("data/ru/bank_reviews.txt", "data/ru/bank_reviews_translit2.txt")
